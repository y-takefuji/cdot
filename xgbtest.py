...
# 3) XGB on ALL FEATURES → get importances
...
print("Set 1 – Top 10 features by XGB importance (all features):")
print(set1, "\n")
...
# 6) XGB on the SELECTED 100 FEATURES
...
print("Set 2 – Top 10 features by XGB importance (within top 100):")
print(set2)
